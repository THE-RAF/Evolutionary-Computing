...
class GALivePlotHandler1D:
    ...
    def plot_GA(self,
        ...
        ax_performance.plot(self.GA.best_fitnesses, c='#77cdf2')
        ax_performance.plot(self.GA.mean_fitnesses, c='#f17587')
...
class GALivePlotHandler2D:
    ...
    def plot_GA(self,
        ...
        ax_performance = figure.add_subplot(122)
        ax_performance.plot(self.GA.best_fitnesses, c=light_blue_hexcode)
        ax_performance.plot(self.GA.mean_fitnesses, c=red_hexcode)
